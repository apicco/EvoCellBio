...
Apl1_sc_l = nlt( sc , 'Apl1' , Apl1_sc , dt = 1.2 , shift = shift_sc )
...
Apl1_sp_l = nlt( sp , 'Apl1' , Apl1_sp , dt = 1.2 , shift = shift_sp )
...
Apl1_um_l = nlt( um , 'Apl1' , Apl1_um , dt = 1.2 , shift = shift_um )
