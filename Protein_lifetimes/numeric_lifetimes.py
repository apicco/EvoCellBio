...
Apl1_sc_l = nlt( sc , 'Apl1' , Apl1_sc , dt = 1.2428 , shift = shift_sc )
data = pd.concat( [ Ede1_sc_l , Apl1_sc_l ] )
...
Apl1_sp_l = nlt( sp , 'Apl1' , Apl1_sp , dt = 1.2428 , shift = shift_sp )
data = pd.concat( [ data , Apl1_sp_l ] )
...
Apl1_um_l = nlt( um , 'Apl1' , Apl1_um , dt = 1.2428 , shift = shift_um )
data = pd.concat( [ data , Apl1_um_l ] )
