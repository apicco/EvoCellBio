...
ys = 3 # vertical size
xs = 8 # horizontal size, constrained by page layout in affinity designer

fig1 = plt.figure( figsize = ( xs , ys ) )#, layout = 'constrained' )
...
fig2 = plt.figure( figsize = ( xs , ys ) )#, layout = 'constrained' )
