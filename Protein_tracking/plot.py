...
def reference_plot_at_24deg( ax ) :
    ax.plot( sla1_sp_24.t() - t0_pb_24deg , 100 * ( sla1_sp_24.coord()[ 0 ] - x0_pb_24deg ) ,label = 'Sla1-GFP in $S. pombe$ at $24\degree$C' , color = sla1_sp_color_24deg )
...
myplot( axes["A"] , sla1_sp_18 , what = 'coord' , label = 'Sla1-GFP in $S. pombe$' , x0 = x0_pb_18deg, t0 = t0_pb_18deg, col = sla1_sp_color , x_scale = 100 )
...
myplot( axes["B"] , sla1_sp_21 , what = 'coord' , label = None, x0 = x0_pb_21deg, t0 = t0_pb_21deg, col = sla1_sp_color , x_scale = 100 )
...
myplot( axes["C"] , sla1_sp_24 , what = 'coord' , label = None, x0 = x0_pb_24deg, t0 = t0_pb_24deg, col = sla1_sp_color , x_scale = 100 )
...
myplot( axes["D"] , sla1_sp_27 , what = 'coord' , label = None, x0 = x0_pb_27deg, t0 = t0_pb_27deg, col = sla1_sp_color , x_scale = 100 )
...
myplot( axes["E"] , sla1_sp_30 , what = 'coord' , label = None, x0 = x0_pb_30deg, t0 = t0_pb_30deg, col = sla1_sp_color , x_scale = 100 )
